...
Set Your Groq API Key: Obtain GROQ_API_KEY from GroqCloud Console and add it to a .env file in the project root.

Run the Backend Server:

git clone https://github.com/Rishabhbansal005/Indian-Heritage-and-Culture
cd Indian-Heritage-and-Culture
